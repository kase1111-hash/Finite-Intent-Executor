...
export const CONTRACT_ABIS = {
  ...
  LexiconHolder: [
    ...
    'function createSemanticIndex(address creator, string keyword, string[] citations, uint256[] relevanceScores) external',
    ...
    'function resolveAmbiguity(address creator, string query, bytes32 corpusHash) external view returns (string citation, uint256 confidence)',
    'function resolveAmbiguityTopK(address creator, string query, bytes32 corpusHash, uint256 k) external view returns (string[] citations, uint256[] confidences)',
    'function resolveAmbiguityBatch(address creator, string[] queries, bytes32 corpusHash) external view returns (string[] citations, uint256[] confidences)',
    'function createCluster(bytes32 clusterId, string description) external',
    'function assignLegacyToCluster(address creator, bytes32 clusterId) external',
    'function getCorpus(address creator) external view returns (tuple(bytes32 corpusHash, string storageURI, uint256 startYear, uint256 endYear, bool isFrozen))',
    'function getSemanticIndex(address creator, string keyword) external view returns (tuple(string keyword, string[] citations, uint256[] relevanceScores))',
    'function getResolution(address creator, string query) external view returns (string[] citations, uint256[] confidences, uint256 resolvedAt)',
